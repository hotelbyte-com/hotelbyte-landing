...
export const products: Product[] = [
  ...
  {
    slug: 'margin-lift',
    name: 'MarginLift AI 顾问',
    nameEn: 'MarginLift AI',
    tagline: 'AI 咨询先行，提效替人，降本增利',
    taglineEn: 'AI advisory first. Replace manual work. Save cost and lift profit.',
    description: 'MarginLift AI 是面向酒店与旅游分销企业的 AI 咨询顾问服务。先找出能省人、省钱、增利的 AI 机会，再交付智能体、流程、看板和托管运营。',
    descriptionEn: 'MarginLift AI is an AI advisory service for hotel and travel distribution businesses. It finds AI opportunities to reduce labor, save cost, and lift profit, then delivers agents, workflows, dashboards, and managed operations.',
    features: [
      { icon: 'Brain', title: 'AI 成本顾问', titleEn: 'AI Cost Advisor', desc: '找出可避免的人力、供应商和流程成本。', descEn: 'Find avoidable labor, supplier, and workflow cost.' },
      { icon: 'Network', title: '人力替代与提效顾问', titleEn: 'Workforce Automation Consultant', desc: '判断哪些工作该替代、辅助或重构。', descEn: 'Decide what AI should replace, assist, or redesign.' },
      { icon: 'GitBranch', title: 'AI 转型路线顾问', titleEn: 'AI Transformation Planner', desc: '把证据转成 ROI、负责人和落地顺序。', descEn: 'Turn evidence into ROI, owners, and rollout sequence.' },
    ],
    valueProposition: '降低高昂迁移成本带来的试错阻力。先用 AI 咨询证明哪些人力和流程成本可以被替代或压缩，哪些分销动作可以提升利润，再把高价值动作升级为实施、监控或平台模块采用。',
    valuePropositionEn: 'Reduce trial friction from expensive migration risk. Use AI advisory to prove which labor and workflow costs can be replaced or reduced, which distribution actions can lift profit, then expand high-value actions into implementation, monitoring, or selected platform modules.',
    techHighlights: [
      'AI advisory map for labor replacement, workflow automation, supplier cost, and profit-lift opportunities',
      'Evidence graph across team tasks, supplier responses, search logs, booking outcomes, rules, and commercial impact',
      'Implementation plan for agents, dashboards, workflow redesign, supplier action, and operating controls',
      'Optional continuation into managed AI operations and HotelByte platform modules only after ROI is proven',
    ],
    techHighlightsEn: [
      'AI advisory map for labor replacement, workflow automation, supplier cost, and profit-lift opportunities',
      'Evidence graph across team tasks, supplier responses, search logs, booking outcomes, rules, and commercial impact',
    ...
    integrationNotes: '首个 Sprint 可基于授权数据导出、运营样本、价格证据和配置快照运行，不要求客户先迁移平台。后续实施可接入 HotelByte 的价格情报、运营诊断、自动化控制或分销模块。',
    integrationNotesEn: 'The first sprint can run from approved exports, operating samples, price evidence, and configuration snapshots without requiring a platform migration. Follow-on implementation can connect HotelByte price intelligence, operational diagnostics, automation controls, or distribution modules.',
    competitorEdge: [
      '不是“另一个更好用的平台”销售，而是 AI 咨询顾问先行',
      '先证明哪些人工、流程和供应商成本可以被 AI 降低，再进入实施方案',
      '覆盖咨询诊断、智能体/流程/看板实施和托管运营，不止停留在报告',
    ],
    competitorEdgeEn: [
      'Not another slightly better platform pitch, but AI advisory first',
      'Proves which labor, workflow, and supplier costs can be reduced with AI before asking for implementation budget',
      'Covers consulting diagnosis, agent/workflow/dashboard delivery, and managed operations instead of stopping at a report',
    ],
    tiers: [
      {
        name: 'AI Advisory Sprint',
        nameEn: 'AI Advisory Sprint',
        focus: '2-4 周付费 AI 咨询诊断',
        focusEn: '2-4 week paid AI advisory diagnostic',
        description: '围绕人力、流程、供应商、利润动作和系统边界，输出证据支持的 AI 自动化与降本增利路线图。',
        descriptionEn: 'A focused advisory sprint across labor, workflows, suppliers, profit actions, and system boundaries, ending with an evidence-backed AI automation and margin roadmap.',
        features: ['AI 机会地图', '人力替代评估', 'ROI 证据', '管理层路线图'],
        featuresEn: ['AI opportunity map', 'Labor replacement assessment', 'ROI evidence', 'Executive roadmap'],
      },
      {
        name: 'Implementation SOW',
        nameEn: 'Implementation SOW',
        focus: '解决方案实施',
        focusEn: 'Solution delivery',
        description: '交付 AI 智能体、流程重构、供应商动作、看板、控制机制和必要的连接器工作。',
        descriptionEn: 'Delivers AI agents, workflow redesign, supplier actions, dashboards, operating controls, and focused connector work.',
        features: ['AI 智能体', '流程重构', '供应商动作', '看板与控制机制'],
        featuresEn: ['AI agents', 'Workflow redesign', 'Supplier actions', 'Dashboards and controls'],
      },
      {
        name: 'Managed AI Operations',
        nameEn: 'Managed AI Operations',
        focus: '托管 AI 运营',
        focusEn: 'Managed AI operations',
        description: '持续运营、衡量和优化已上线 AI 工作流，提供月度管理层复盘和价值追踪。',
        descriptionEn: 'Operates, measures, and improves deployed AI workflows with monthly executive reviews and impact tracking.',
        features: ['AI 工作流运营', '价值追踪', '规则/提示词优化', '管理层复盘'],
        featuresEn: ['AI workflow operation', 'Impact tracking', 'Rule/prompt optimization', 'Executive review'],
      },
    ],
  },
  {
